		...
		<div class="col-full tags">
			...
			<div class="tagcloud">
                ...
                if(is_array($philosophy_footer_tag_items)){
	                foreach ($philosophy_footer_tag_items as $pft){
		                printf('<a href="%s">%s</a>',get_term_link($pft->term_id),$pft->name);
	                }
                }
                ?>
			</div> <!-- end tagcloud -->
	...
	<div class="s-footer__main">
		<div class="row">
			...
			<div class="col-two md-four mob-full s-footer__archives">
				...
				<?php
				if(is_active_sidebar("footer-left-archive")){
					dynamic_sidebar("footer-left-archive");
				}
