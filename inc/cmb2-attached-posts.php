...
function cmb2_attached_posts_field_metaboxes_example() {
	...
	$example_meta->add_field( array(
		...
		'desc'    => __( 'Drag chapters from the left column to the right column to attach them to this page.<br />You may rearrange the order of the posts in the right column by dragging and dropping.', 'yourtextdomain' ),
